...
export const languageMapping = {
  metaInfluencer: {
    ...
    subtitle: {
      en: "3D Art × Technology × Marketing",
  ...
  shefla: {
    ...
    subtitle: {
      en: "Brand Marketing × Social Media",
  ...
  otherSection: {
    item1: {
      ...
      description: {
        en: "We are recruiting teammates regardless of age or background.",
        ja: "年齢・経歴問わずチームメイトを広く募集しています"
      },
      buttonLabel: {
        en: "Learn More",
        ja: "Learn More"
    ...
    item2: {
      ...
      description: {
        en: "Feel free to contact us for quotes or consultations.",
        ja: "お見積りやご相談などお気軽にお問い合わせください"
      },
      buttonLabel: {
        en: "Contact us",
        ja: "Contact us"
